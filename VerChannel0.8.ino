...
// 定时广播间隔
#define BROADCAST_INTERVAL 2000 // 每5秒广播一次
...
void drawColorButtons() {
    ...
    tft.setTextColor(TFT_WHITE);
    tft.drawCentreString(String(macSet.size()), SLEEP_BUTTON_X + SLEEP_BUTTON_W / 2, SLEEP_BUTTON_Y + 2, 2);
}
...
void loop() {
    ...
    if (currentTime - lastBroadcastTime >= BROADCAST_INTERVAL) {
        ...
        // 更新设备数量显示
        drawColorButtons(); // 重新绘制颜色按钮以更新显示
